...
- To add a new language later, edit [microservice-quizz/src/app/services/triviaCategories.ts](microservice-quizz/src/app/services/triviaCategories.ts) and restart/rebuild.
