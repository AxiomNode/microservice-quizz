# Agents & Contribution Rules for microservice-quiz

Purpose
-------
This document defines agent rules, development workflow, and code quality standards for the microservice-quiz repository.
